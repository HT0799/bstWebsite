<template>
    <div class="news-content">
      <div class="news-header">
        <div class="section-normal-title">{{ t("news.annunciate") }}<span>{{ t("news.proclamation") }}</span></div>
  ...
  const newsData = ref<NewsItem[]>([
    {
      ...
      day: "25",
      month: "7月\n2025",
      title: "萍乡百斯特电瓷有限公司公开招聘补充公告",
      description:
        '任职要求1.年龄要求：35周岁及以下（1989年5月1日以后出生）（与原公告一致）。2.学历要求：全日制硕士研究生及以上（与原公告一致）。3.专业要求：纪检监察、财务、审计、法学、经济犯罪侦查、经济学、工商管理等专业',
      content: "完整新闻内容...",
    ...
    },
    {
      ...
      day: "26",
      month: "3月\n2023",
      title: "萍乡百斯特电瓷有限公司选聘会计师事务所项目招标公告",
      description:
        '萍乡百斯特电瓷有限公司选聘会计师事务所项目招标公告',
      content: "完整新闻内容...",
      image: newsPlaceholder,
    },
    {
